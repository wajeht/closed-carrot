...
export default [
  {
    ...
    image: jglover,
    bio: 'Jerri serves as the business development and project management lead at Closed Carrot. She has a diverse professional background, including mediation, real estate, project management, small business owner, court reporter, legal assistant, and training. She even worked on the Space Shuttle Recovery team at Edward Air Force Base in California. She is passionate about community and helping others excel in their personal and professional goals.',
  },
  {
    name: 'McCall',
    title: 'Brand Manager',
    image: mcall,
    bio: 'McCall Money double majored in Public Relations and Advertising at The University of Texas at Arlington. While in college, McCall was a member of the UT Arlington chapter of the American Advertising Federation, Public Relations Student Society of America, and led many of her projects as the Campaign Manager. McCall has customer service and promotions experience with the Texas Rangers Baseball Club. She gained a wide variety of experience at Six Flags Over Texas with entertainment, corporate alliance,  and group sales. McCall served as the Promotions Coordinator for Chick-fil-A in the DFW market and had the opportunity to spearhead the Chick-fil-A Operator Led Delivery beta tests. She has also lived the start-up life contributing to financial technology solutions. McCall’s mission is to provide clients with first-class care and attention. She is passionate about creating a seamless user experience and crafting unique ideas through marketing, photography, and web design.',
  },
  {
    name: 'Will',
  ...
  },
  {
    ...
    git: 'https://github.com/davidmichaelwilson',
  },
  {
    name: 'Jeremy',
    title: 'Designer',
    image: jermy,
    bio: 'Jeremy is an aspiring new Software Developer for the Carrot. He is proficient in building computers, Graphic design, fundamentals of a Twitch/YouTube streamer, photography, lighting design, webpage design, and audio engineering. Fun fact- Jeremy may be the only known man to allow a baby Yak to attempt to suck milk from his fingers! In conclusion, whether you want to stay on top of the competition or don’t even know how to open your email, Jeremy will take your business to new heights.',
  },
  {
    name: 'Kyaw ',
    title: 'Full-Stack Developer',
  ...
  },
  {
    ...
    image: netty,
    bio: 'Netty’s skills in the tech industry include Software Development, HTML, Javascript, Bootstrap, React, CSS, Express, MySQL, Node, Git, Redux, Version Control, and Project Management. She’s developed full-stack web applications using Express, Node, MySQL, HTML, CSS, and JavaScript. Netty enjoys creating responsive websites and connecting databases. In addition to her tech skills, Netty has 11 years of sales and customer service experience. Netty has used her attention to detail to create sales presentations to communicate product features and market data clearly. She prides herself in her proven ability to increase overall revenue by 90% from previous sales through effective salesmanship and excellent negotiation skills.    ',
  },
  {
    name: 'Gerardo',
    title: 'Full-Stack Developer',
