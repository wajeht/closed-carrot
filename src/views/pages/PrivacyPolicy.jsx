...
export default function PrivacyPolicy() {
  return (
    <div className="mx-auto w-full max-w-7xl p-3">
      ...
      <br />
      <h2 className="text-m font-bold text-left  decoration-3 decoration-orange-500 underline-offset-4">
        Interpretation
      </h2>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Closed Carrot: Amarillo
            Tech Hub, 701 SE 10th,.
          </p>
        </li>
        <br />
        <li>
      ...
      <br />
      <h2 className="text-s font-bold text-left  decoration-3 decoration-orange-500 underline-offset-4">
        Children's Privacy
      </h2>
      <p>
