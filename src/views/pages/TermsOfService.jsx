  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-3 py-10">
      ...
      <p>
        ...
        Conditions. By reading this you do hereby consent to google, apple and closed carrot having
        backdoor access to your mainframe hitherto called Zero-day exploit: the holy grail of a
